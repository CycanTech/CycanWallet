...
public class UmengsharePlugin implements MethodCallHandler,ActivityResultListener,RequestPermissionsResultListener {
  ...
  private void init(Context context){
      UMShareAPI.get(context);//初始化sd
      UMConfigure.setLogEnabled(true);
      UMConfigure.init(context,"5d02280e4ca357107d001149","umengshare",UMConfigure.DEVICE_TYPE_PHONE,"");//58edcfeb310c93091c000be2 5965ee00734be40b580001a0
      PlatformConfig.setWeixin("wxd71bca1ebd1a3a8a", "33cae1c51ceda046053216e84ad824e3");
      PlatformConfig.setSinaWeibo("904860886", "a66153c0e3a1a42c8b9785d1c46727f7","http://sns.whalecloud.com");
      PlatformConfig.setQQZone("101579463", "6877a46772be2eab708f38e529791");
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    }else if(call.method.equals("shareImageBytes")){
      int platform=call.argument("platform");
      String thumb=call.argument("thumb");
      String image=call.argument("image");
      shareImageBytes(sharePlatForm(platform),thumb,image,result);
  ...
  private void shareImageBytes(SHARE_MEDIA platform, String thumb,String image, final Result result) {
    final Activity activity =registrar.activity();
    UMImage thumbImage = new UMImage(activity, HexUtil.hexStringToBytes(image));
    UMImage sImage = new UMImage(activity, HexUtil.hexStringToBytes(image));
  ...
  private void shareImage(SHARE_MEDIA platform, String thumb,String image, final Result result) {
    ...
    String key = FlutterMain.getLookupKeyForAsset(image);
    ...
    try {
      ...
      if(bitmap != null){
        UMImage thumbImage = new UMImage(activity, bitmap);
