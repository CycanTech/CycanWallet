...
class UMengShare {
  ...
  /// 
  /// 返回参数说明 um_status : SUCCESS 成功 ERROR 失败 CANCEL 用户取消
  static Future<dynamic> shareImageBytes(UMSharePlatform platform,String thumb,String image) async{
    Map<dynamic,dynamic> result = await _channel.invokeMethod('shareImageBytes',{'platform':platform.index,"thumb":thumb,"image":image});
    return result;
  }
  /// 分享媒体
  /// 
