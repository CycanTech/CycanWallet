...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if ([@"shareText" isEqualToString:call.method]) {
        ...
        NSString* key = [self.registrar lookupKeyForAsset:image];
        NSString* path = [[NSBundle mainBundle] pathForResource:key ofType:nil];
        [self shareImage:[self sharePlatform:platformType] withImage:[UIImage imageWithContentsOfFile:path] withThumb:thumb result:result];
...
//    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:@"3921700954"  appSecret:@"04b48b094faeb16683c32669824ebdad" redirectURL:@"https://sns.whalecloud.com/sina2/callback"];
    ...
    [UMConfigure initWithAppkey:@"5bc0012cb465f57dd6000027" channel:@"umengshare"];
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wx055a7e49ff00e45a" appSecret:@"cd49579c2425378516526c592408104d" redirectURL:@""];
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:@"3243777381" appSecret:@"d1ac9420dd14fe3fdbd8258f912cd06d" redirectURL:@""];
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Qzone appKey:@"101513408" appSecret:@"94cb743e4ecd693e9b71018f8df775ef" redirectURL:@""];
