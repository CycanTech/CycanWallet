...
class ScanResultUtils {
  static ScanResulObjects disposeQRCode(String codeResult, int chainType) {
    ...
    if(_disposeChainType(codeResult) == 99){
        ...
        return scanResulObjects;
    } else if (MCoinType.MCoinType_ETH.index == chainType || MCoinType.MCoinType_VNS.index == chainType) {
      return _disposeEth(codeResult, chainType);
    } else if (MCoinType.MCoinType_EOS.index == chainType) {
      return _disposeEos(codeResult, chainType);
    } else if (MCoinType.MCoinType_BTC.index == chainType || MCoinType.MCoinType_LTC.index == chainType || MCoinType.MCoinType_BTM.index == chainType) {
      return _disposeBtc(codeResult, chainType);
    }
  }
