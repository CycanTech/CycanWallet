...
class ChannelNative {
  ...
  //加密
  static Future<String> encKeyByAES128CBC(String input, String inputPIN) async {
    if (input == null ||
        input.length == 0 ||
        inputPIN == null ||
        inputPIN.length == 0) {
  ...
  //验证ETH交易数据
  static Future<bool> checkETHpushValid(String pushStr, String to, String value,
      int decimal, String contractAddr) async {
    if (pushStr == null ||
        pushStr.length == 0 ||
        to == null ||
        to.length == 0 ||
