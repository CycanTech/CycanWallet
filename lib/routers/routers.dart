...
class Routers {
  ...
  static String mineMsgPage = "mineMsgPage";
...
//配置路由
  static void configureRoutes(FluroRouter router) {
    ...
    // router.define(bigBusinessTrackingDetailPage,
    //     handler: bigBusinessTrackingDetailPageHandler);
    // router.define(ramDetailPage, handler: ramDetailPageHandler);
    // router.define(ramTransferPagePage, handler: ramTransferPageHandler);
    // router.define(cpuNetTransferPage, handler: cpuNetTransferPageHandler);
    // router.define(registerShowKeyPage, handler: registerShowKeyPageHandler);
    // router.define(registerInputAccoutPage,
    //     handler: registerInputAccoutPageHandler);
    // router.define(registerCreateCodePage,
    //     handler: registerCreateCodePageHandler);
    ...
    router.define(chooseCoinTypePage, handler: chooseCoinTypePageHandler);
    ...
    router.define(mineMsgPage, handler: mineMsgPageHandler);
    router.define(nodeAddPage, handler: nodeAddPageHandler);
    // router.define(currencyMarketInfoPage,
  ...
  static String _paramsToString(Map<String, dynamic> params, query) {}
