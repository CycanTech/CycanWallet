...
public class Constants {
    ...
    public interface COIN_TYPE {
        int TYPE_ALL = 0;// 0:所有链
        int TYPE_BTC = 1;// 1:btc
        int TYPE_ETH = 2;// 2:eth
        int TYPE_EOS = 3;// 3:eos
        int TYPE_VNS = 4;// 4:vns
        int TYPE_BTM = 5;// 5:btm
        int TYPE_LTC = 6;// 6:ltc
        int TYPE_USDT = 7;// 7:usdt
        int TYPE_GPS = 8;// 8:gps
        int TYPE_POLKADOT = 9;// 9:polkadot
        int TYPE_BCH = 10;// 10:bch
        int TYPE_DASH = 11;// 11:dash
    }
